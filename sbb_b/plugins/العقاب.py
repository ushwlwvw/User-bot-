...
c = requests.session()
bot_username = '@eue1Bot'
tepthon = ['yes']


@sbb_b.on(admin_cmd(pattern="(تجميع البرنس|تجميع برنس)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await sbb_b.send_message('@eue1Bot', '/start')
        await asyncio.sleep(5)
        msg0 = await sbb_b.get_messages('@eue1Bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sbb_b.get_messages('@eue1Bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await sbb_b.get_messages('@eue1Bot', limit=1)
